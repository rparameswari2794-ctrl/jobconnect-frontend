...
function AdminJobSeekerProfile() {
    ...
    // =====================================================
    // APPROVAL STATUS FOR BACK NAVIGATION
    // =====================================================

    const approvalStatus =
        String(profile?.approval_status || "")
            .trim()
            .toLowerCase();
    ...
    // BACK NAVIGATION
    // APPROVED → USERS
    // NOT APPROVED → VERIFICATION QUEUE
    // =====================================================
    ...
    return (
        ...
        <div className="admin-dashboard">
            ...
            <main className="admin-main admin-jobseeker-profile-page">
                ...
                <section className="profile-card disability-card">

                    <div className="profile-card-header">

                        <div className="profile-section-icon disability-icon">
                            ♿
                        </div>
                        ...
                        <div>
                            ...
                            <p>
                                Disability details submitted by the job seeker.
                            </p>
                    ...
                    <div className="disability-status-banner">

                        <div className="disability-status-left">

                            <span className="disability-status-symbol">
                                ♿
                            </span>
                    ...
                    {hasDisability ? (
                        ...
                        <div className="profile-info-grid disability-details-grid">


                            <div className="profile-info-item disability-info-item">
                        ...
                        <div className="disability-not-available">
                            ...
                            <p>
                                This job seeker has not declared a disability.
                            </p>
                ...
                <section className="profile-card">
                    ...
                    <div className="document-list">
                        ...
                        <div className="document-row disability-document-row">

                            <div className="document-icon disability-document-icon">
                                ♿
                            </div>
                            ...
                            <div className="document-content">
                                ...
                                <p>
                                    Disability document submitted for verification
                                </p>
...
.disability-status-left span:last-child {
