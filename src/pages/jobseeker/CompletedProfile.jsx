...
export default function ProfileDetails() {
    ...
    const saveProject = async () => {
        ...
        try {
            ...
            // The backend returns { message, project, data } for POST/PATCH.
            // Reload the actual project array so the UI always contains the
            // real saved Project objects instead of the response wrapper.
            const refreshedProjects = await apiRequest(PROJECT_API);
            setProjectList(
    ...
    const deleteProject = async (projectId) => {
        if (!projectId) {
            setError("Unable to delete project: project ID is missing.");
            return;
        }
    ...
    const editProject = (item) => {
        setProjectForm({
            ...
            project_url: item.project_url || item.project_link || "",
...
.project-card-actions .icon-button.danger:hover {
    color: #c62828;
    border-color: #e0b4b4;
    background: #fff5f5;
}
